...
const seedJobs = async () => {
  try {
    ...
    if (!user) {
      console.log('⚠️  No users found. Creating a default employer user...');
      ...
      console.log('✅ Default employer user created');
    }
    ...
    console.log(`✅ Successfully added 30 jobs to the database!`);
